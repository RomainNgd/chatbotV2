<bot>
    <div id="bulle" class="hide-bulle">
        <div>
            <img src="/chatbot/assets/img/croix.png" alt="" id="bulle-croix">
        </div>
        <div class="brand">
    ...
    <div id="chatbox" class="close-chatbox">
        <div id="chatbox-header">
            ...
            <div class="brand">
                <img id="reset" class="logo" src="/chatbot/assets/img/reload.png" alt="" onclick="reset('Chat réinitialisé avec succès, que puis-je faire pour vous ?')">
        ...
        <div id="footer-chatbox">
            ...
            <img onclick="sendMessage()" id="envoyer" src="/chatbot/assets/img/send-message.png" alt="send button">
        </div>
    </div>
</bot>